...
public class PublishOnSubscribeOnCombined {
    private static final Logger log = LoggerFactory.getLogger(PublishOnSubscribeOnCombined.class);
    ...
    static void main(String[] args) {
        var flux = Flux.create(sink -> {
                ...
                .subscribeOn(Schedulers.boundedElastic())// 2nd publish from another thread
