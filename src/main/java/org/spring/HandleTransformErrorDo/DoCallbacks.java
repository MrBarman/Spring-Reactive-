...
public class DoCallbacks {
    ...
    //Focus and Understand properly the order in which do methods are getting executed
    //Execution will start from subscriber and move from bottom to top to the producer
    //And again will move from top to bottom as subscription object will go to bottom
